...
export class GmailService {
  ...
  generateSelectionEmail(
    ...
    const galleryUrl = `${baseUrl}/favorites/${encodeURIComponent(galleryId)}`;
    
    // Logo SVG inline with proper styling for email
    const logoSvg = `<svg width="40" height="40" viewBox="0 0 215.29 215.93" xmlns="http://www.w3.org/2000/svg" style="vertical-align: middle;">
      <g>
        <path fill="#ffffff" d="M96.09.47c88.31-7.93,148.52,85.13,104.37,162.37-41.55,72.68-148.39,70.05-187.69-3.65C-22.95,92.21,19.9,7.32,96.09.47ZM103.08,3.47C21.81,6.35-23.51,98.39,20.88,166.08c42.07,64.15,139.4,61.21,176.93-5.89C237.79,88.7,185.17.57,103.08,3.47Z"/>
        <path fill="#ffffff" d="M71.29,48.17v42l38.45-41.05,11.55-.93-38.92,40.63,27.92,32.36v-41c0-1.46,26.97-1.05,29.24-.74,21.84,2.98,31.63,29.87,13.79,44.26l-10.02,5.96,29.99,40.51h-14.5c-2.36,0-23.71-34.12-27.93-38.07l-7.57-.93v39c0,.65-13,.65-13,0v-30.5c0-2.91-35.26-37.02-38.51-43.49-3.06-.26-.49,1.08-.49,1.49v42.5c0,.65-13,.65-13,0V48.17c0-.65,11.61.48,13,0ZM123.29,86.17c-1.3,1.28,0,31.57,0,36.5,0,.21-1.49,1.13-1,1.49.43.31,9.06.2,10.54.05,23.13-2.36,20.89-33.02,4.73-36.81-1.4-.33-13.76-1.73-14.27-1.23Z"/>
      </g>
    </svg>`;
